class UsersController < ApplicationController
  ...
  def home
    ...
    @results_cool = [{"type" => "status", "picture" => "http://www.thedogtrainer.co.uk/images/2-puppy-training-group-classes-house-training-toliet-training-kent-sheppey-maidstone-medway-puppy-foundation.jpg", "message" => "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."},{"type" => "status", "picture" => "http://www.thedogtrainer.co.uk/images/2-puppy-training-group-classes-house-training-toliet-training-kent-sheppey-maidstone-medway-puppy-foundation.jpg", "message" => "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."},{"type" => "status", "picture" => "http://www.thedogtrainer.co.uk/images/2-puppy-training-group-classes-house-training-toliet-training-kent-sheppey-maidstone-medway-puppy-foundation.jpg", "message" => "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."},{"type" => "status", "picture" => "http://www.thedogtrainer.co.uk/images/2-puppy-training-group-classes-house-training-toliet-training-kent-sheppey-maidstone-medway-puppy-foundation.jpg", "message" => "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."}]
